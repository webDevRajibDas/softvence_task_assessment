...
<head>
    ...
    <title>@yield("title") | Courses||Dashboard</title>
    <!-- CSRF Token -->
    ...
    <link href="{{asset('dashboard/assets/summernote-bs5.css')}}" rel="stylesheet">
...
<script
        src="{{asset('dashboard/assets/dist/js/bootstrap.bundle.min.js')}}"
        class="astro-vvvwv3sm"
></script>
<script src="{{asset('dashboard/assets/summernote-bs5.js')}}"></script>
<script src="{{asset('dashboard/dashboard.js')}}" class="astro-vvvwv3sm"></script>
</body>
</html>
